...
public class ImageDetailFragment extends Fragment {
    ...
    public static ImageDetailFragment newInstance(int imageId) {
        ...
        args.putInt(IMAGE_DATA_EXTRA, imageId);
        f.setArguments(args);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mImageId = getArguments() != null ? getArguments().getInt(IMAGE_DATA_EXTRA) : null;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (ImageDetailActivity.class.isInstance(getActivity())) {
            ImageShower.showImage(mImageId, mImageView, this);
        }
